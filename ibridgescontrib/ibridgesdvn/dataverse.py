...
class DataverseOperations:
    ...
    def __init__(self, url: str, token: str):
        """
        Initializes the DataverseOperations instance.
    ...
    def user_authenticated(self) -> True:
        """
        Verifies if the user token is valid for the Dataverse instance.
    ...
    def get_dataverse_info(self, dataverse):
        """
        Retrieves the children (datasets and sub-dataverses) of a specified Dataverse.
    ...
    def dataverse_exists(self, dataverse: str):
        """
        Checks whether a specified Dataverse exists.
    ...
    def list_dataverse_content(self, dataverse: str) -> dict:
        """
        Retrieves the list of datasets and sub-dataverses contained within a specified Dataverse.
    ...
    def get_dataset_info(self, data_id: str):
        """
        Retrieves metadata and information for a dataset using its DOI identifier.
    ...
    def create_dataset(
        ...
        """
            Creates a new dataset in a specified Dataverse repository.
    ...
    def add_datafile_to_dataset(
        self, dataset_id: str, file_path: Path, verbose: bool = True
    ):
        """
        Uploads a data file to a specific dataset.
